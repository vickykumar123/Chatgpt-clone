-- Add UNIQUE constraint for messageId
ALTER TABLE messages
ADD CONSTRAINT unique_message_id UNIQUE (messageId);

-- Add a CHECK constraint to prevent circular references
ALTER TABLE messages
ADD CONSTRAINT no_circular_references CHECK (messageId IS DISTINCT FROM parentMessageId);
